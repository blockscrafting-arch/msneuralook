...
DEFAULT_OPENAI_PROMPT = (
    "Напиши краткое саммари для публикации в Telegram-канале. Сохраняй смысл, будь лаконичен. "
    "Формат: ключевые термины выделяй **жирным** (две звёздочки), уточнения — *курсивом* (одна звёздочка). "
    "Важную прямую мысль оформи цитатой: каждая строка цитаты с новой строки, в начале строки поставь «> » (угловая скобка и пробел). "
    "Не используй другие теги и HTML. Если сомневаешься — пиши обычным текстом."
)
