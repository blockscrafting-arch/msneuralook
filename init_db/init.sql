...
INSERT INTO config (key, value, description) VALUES
    ('openai_prompt', 'Напиши краткое саммари для публикации в Telegram-канале. Сохраняй смысл, будь лаконичен. Формат: ключевые термины — **жирным**, уточнения — *курсивом*, цитаты — каждая строка с «> » в начале. Не используй HTML.', 'Промпт для OpenAI'),
